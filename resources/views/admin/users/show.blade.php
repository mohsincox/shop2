<x-layouts.admin :title="'Customer · '.$user->name">
    <nav class="text-sm text-slate-500">
        <a href="{{ route('admin.users.index') }}" class="hover:text-indigo-600">&larr; Back to customers</a>
    </nav>
    ...
    <div class="mt-4 rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-700 p-6 text-white">
        <div class="flex flex-wrap items-center gap-6">
            ...
            <div class="rounded-2xl bg-white/10 px-6 py-4 text-center backdrop-blur">
                ...
                <p class="text-xs text-indigo-200">Total orders</p>
            </div>
        </div>
    </div>
    ...
    <div class="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-100 px-6 py-4">
            <h2 class="font-extrabold text-slate-900">Order history</h2>
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center text-slate-400">
                                <p class="text-4xl">&#128230;</p>
                                <p class="mt-3 font-semibold">This customer hasn't placed any orders yet.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
